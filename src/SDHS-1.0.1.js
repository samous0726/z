...
( function (win, $$) {
    ...
    win.Date.prototype._Format = function (fmt) { //author: meizz
            var o = {
    ...
    _Z. Format = {
        ...
        fromDateGenerator: function ( date, format ) {
            ...
            while ( applyDate < current ) {
                arr.push( applyDate._Format( format ) );
                var m = applyDate.getMonth() + 1;
                applyDate.setMonth( m );
            }
            return arr.reverse();
        },
